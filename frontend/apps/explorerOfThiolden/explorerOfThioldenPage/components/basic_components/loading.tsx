    ...
    return (<>
        ...
        <LotusLoading width ={size}>
            ...
            <LoadingOne render={LoadingRenderNumber == 1}>
                <Image src= "https://d1f9hywwzs4bxo.cloudfront.net/modules/ddu-app/s2Explorer/loading/wait1.png"  alt="Dragon silver icon" width={1000} height={1000}/>
            </LoadingOne>

            <LoadingTwo render={LoadingRenderNumber == 2}>
                <Image src= "https://d1f9hywwzs4bxo.cloudfront.net/modules/ddu-app/s2Explorer/loading/wait2.png"  alt="Dragon silver icon" width={1000} height={1000}/>
            </LoadingTwo>

                    
            <LoadingThree render={LoadingRenderNumber == 3}>
                <Image src= "https://d1f9hywwzs4bxo.cloudfront.net/modules/ddu-app/s2Explorer/loading/wait3.png"  alt="Dragon silver icon" width={1000} height={1000}/>
            </LoadingThree>

            <LoadingFour render={LoadingRenderNumber == 4}>
                <Image src= "https://d1f9hywwzs4bxo.cloudfront.net/modules/ddu-app/s2Explorer/loading/wait4.png"  alt="Dragon silver icon" width={1000} height={1000}/>
            </LoadingFour>

            <LoadingFive render={LoadingRenderNumber == 5}>
                <Image src= "https://d1f9hywwzs4bxo.cloudfront.net/modules/ddu-app/s2Explorer/loading/wait5.png"  alt="Dragon silver icon" width={1000} height={1000}/>
            </LoadingFive>
